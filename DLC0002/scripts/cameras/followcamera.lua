...
function FollowCamera:IsControllable() --Whoops looks like this is a dupe of the CanControl function 
...
function FollowCamera:Update(dt)
    ...
    if self.cutscene then
        ...
        self.currentpos.x = lerp(self.currentpos.x, self.targetpos.x, dt * pan_speed)
        self.currentpos.y = lerp(self.currentpos.y, self.targetpos.y, dt * pan_speed)
        self.currentpos.z = lerp(self.currentpos.z, self.targetpos.z, dt * pan_speed)

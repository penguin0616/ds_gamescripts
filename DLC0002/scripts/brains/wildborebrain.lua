    ...
    local day = WhileNode( function() return clock and clock:IsDay() end, "IsDay",
        PriorityNode{
            ...
            ChattyNode(self.inst, STRINGS.BORE_TALK_RUNAWAY_WILSON,
                    RunAway(self.inst, "player", START_RUN_DIST, STOP_RUN_DIST, ShouldRunFromPlayerFn)),
            ...
            ChattyNode(self.inst, STRINGS.BORE_TALK_FIGHT,
                WhileNode( function() return self.inst.components.combat.target and self.inst.components.combat:InCooldown() end, "Dodge",
                    RunAway(self.inst, function() return self.inst.components.combat.target end, RUN_AWAY_DIST, STOP_RUN_AWAY_DIST, 
                        function(hunter, runner) return runner.components.combat:InCooldown() end))),

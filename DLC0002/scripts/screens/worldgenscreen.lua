...
local WorldGenScreen = Class(Screen, function(self, profile, cb, world_gen_options)
	...
	if world_gen_options.level_type == "shipwrecked" or world_gen_options.level_type == "volcano" then
    ...
    elseif world_gen_options.level_type == "shipwrecked" then
    	TheFrontEnd:GetSound():PlaySound("dontstarve_DLC002/common/GenShipwrecked_LP", "worldgensound")
	elseif world_gen_options.level_type == "volcano" then
		TheFrontEnd:GetSound():PlaySound("dontstarve_DLC002/common/GenShipwrecked_volcano_LP", "worldgensound")
	else

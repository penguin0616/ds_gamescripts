...
Action = Class(function(self, data, priority, instant, rmb, distance, crosseswaterboundary) 
...
ACTIONS=
{
	...
	MATE = Action({}),
	CRAB_HIDE = Action({}),
	DRINK = Action({mount_enabled=true}),
	TIGERSHARK_FEED = Action({}),
	FLUP_HIDE = Action({}),
	THROW = Action({mount_enabled=true},0, false, true, 20, true),

...
levellist[LEVELTYPE.VOLCANO] = {}
levellist[LEVELTYPE.SHIPWRECKED] = {}
...
require("map/levels/volcano")
require("map/levels/shipwrecked")
...
return { story_levels=levellist[LEVELTYPE.ADVENTURE],
			...
			volcano_levels = levellist[LEVELTYPE.VOLCANO],
			shipwrecked_levels = levellist[LEVELTYPE.SHIPWRECKED],

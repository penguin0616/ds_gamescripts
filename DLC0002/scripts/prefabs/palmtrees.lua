...
local function makefn(build, stage, data)
	...
	local function fn(Sim)
		...
		inst.components.blowinwindgust:SetWindSpeedThreshold(TUNING.PALMTREE_WINDBLOWN_SPEED)
		inst.components.blowinwindgust:SetDestroyChance(TUNING.PALMTREE_WINDBLOWN_FALL_CHANCE)

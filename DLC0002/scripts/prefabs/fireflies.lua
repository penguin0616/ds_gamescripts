...
local function updatelight(inst)
    if GetClock():IsNight() and not GetSeasonManager():IsWetSeason() and not inst.components.playerprox:IsPlayerClose() and not inst.components.inventoryitem.owner then

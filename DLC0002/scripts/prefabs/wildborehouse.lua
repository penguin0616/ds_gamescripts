...
local function onoccupied(inst, child)
    if not inst:HasTag("burnt") then
    	inst.SoundEmitter:PlaySound("dontstarve_DLC002/creatures/wild_boar/boar_in_hut", "pigsound")
...
return Prefab( "common/objects/wildborehouse", fn, assets, prefabs ),
	   MakePlacer("common/wildborehouse_placer", "pig_house", "pig_house_tropical", "idle")  

...
local function onload(inst, data)
    ...
    --inst:DoTaskInTime(0,function() setfertilityfn(inst, inst.components.grower:GetFertilePercent()) end)
...
return --Prefab( "common/objects/farmplot",  plot(1), assets, prefabs ),
	   ...
	   MakePlacer( "common/slow_farmplot_placer", "farmplot", "farmplot", "full", true, nil, nil, nil, nil, 90 ),
	   MakePlacer( "common/fast_farmplot_placer", "farmplot", "farmplot", "full", true, nil, nil, nil, nil, 90  ) 
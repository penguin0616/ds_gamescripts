...
return
	   ...
	   MakePlacer( "common/slow_farmplot_placer", "farmplot", "farmplot", "full", true, nil, nil, nil, nil, 90, nil, nil, nil, nil, placerdecor(2)), 
	   MakePlacer( "common/fast_farmplot_placer", "farmplot", "farmplot", "full", true, nil, nil, nil, nil, 90, nil, nil, nil, nil, placerdecor(3))
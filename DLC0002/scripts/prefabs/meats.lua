...
local function driedmonster(Sim)
    ...
    MakeInventoryFloatable(inst, "idle_dried_monster_water", "idle_dried_monster")
...
local function driedmeat(Sim)
    ...
    MakeInventoryFloatable(inst, "idle_dried_large_water", "idle_dried_large")
    inst.components.edible.foodstate = "DRIED"
    inst.components.edible.healthvalue = TUNING.HEALING_MED
    inst.components.edible.hungervalue = TUNING.CALORIES_MED
    inst.components.edible.sanityvalue = TUNING.SANITY_MED
...
local function raw(Sim)
    ...
    MakeInventoryFloatable(inst, "idle_raw_water", "raw")
...
local function driedsmallmeat(Sim)
    ...
    MakeInventoryFloatable(inst, "idle_dried_small_water", "idle_dried_small")
    MakeBlowInHurricane(inst, TUNING.WINDBLOWN_SCALE_MIN.LIGHT, TUNING.WINDBLOWN_SCALE_MAX.LIGHT)

...
local function fn(Sim)
    ...
    inst.components.fueled:SetUpdateFn( function()
        ...
        if GetSeasonManager() and GetSeasonManager():IsRaining() then
            rate = 1 + TUNING.OBSIDIANFIREPIT_RAIN_RATE*GetSeasonManager():GetPrecipitationRate()
        end
...
return Prefab( "common/objects/obsidianfirepit", fn, assets, prefabs),
		MakePlacer( "common/obsidianfirepit_placer", "firepit", "firepit", "preview" ) 

...
local states=
{
    ...
    State{
        ...
        {   
            ...
            TimeEvent(20*FRAMES, function(inst) inst.SoundEmitter:PlaySound(inst.sounds.spit) end),
            TimeEvent(20*FRAMES, function(inst) inst.SoundEmitter:PlaySound(inst.sounds.voice) end),

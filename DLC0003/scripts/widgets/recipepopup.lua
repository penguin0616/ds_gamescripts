    ...
    for k,v in pairs(TUNING.PROTOTYPER_TREES) do
        ...
        if k ~= "SEALAB" then
            ...
            if player and player.components.builder then
                ...
                elseif player.components.builder.magic_bonus and (k == "HOGUSPORUSATOR" or k == "PRESTIHATITATOR" or k == "SHADOWMANIPULATOR") then
            ...
            for rk,rv in pairs(adjusted_level) do
                if TUNING.PROTOTYPER_TREES[v.TREE][rk] == rv then
                    ...
                    if player and player.components.builder then
                        ...
                        elseif player.components.builder.magic_bonus and (v.TREE == "HOGUSPORUSATOR" or v.TREE == "PRESTIHATITATOR" or v.TREE == "SHADOWMANIPULATOR") then

...
local wave_to_season = {
	...
	["lush"] = SEASONS.LUSH,
	["humid"] = SEASONS.HUMID,
	["aporkalypse"] = SEASONS.APORKALYPSE,
}
...
local wave_sound = SaveGameIndex:IsModePorkland() and { 
	["autumn"] = "dontstarve/common/clouds",
	["winter"] = "dontstarve/common/clouds",
	["spring"] = "dontstarve/common/clouds",
	["summer"] = "dontstarve/common/clouds",
	["mild"] = "dontstarve/common/clouds",
	["wet"] = "dontstarve/common/clouds",
	["green"] = "dontstarve/common/clouds",
	["dry"] = "dontstarve/common/clouds",
...
local AmbientSoundMixer = Class(function(self, inst)
	...
	self.ambient_sounds =
	{
		...
		--Porkland
		[GROUND.DEEPRAINFOREST] = 	{sound="dontstarve_DLC003/amb/temperate/deep_rainforest",	temperate="dontstarve_DLC003/amb/temperate/deep_rainforest", lush="dontstarve_DLC003/amb/warm/deep_rainforest", humid="dontstarve_DLC003/amb/cold/deep_rainforest", aporkalypse = "dontstarve_DLC003/amb/aporkalypse/deep_rainforest" },
		[GROUND.RAINFOREST] = 		{sound="dontstarve_DLC003/amb/temperate/rainforest",		temperate="dontstarve_DLC003/amb/temperate/rainforest",		 lush="dontstarve_DLC003/amb/warm/rainforest",		humid="dontstarve_DLC003/amb/cold/rainforest", 		aporkalypse = "dontstarve_DLC003/amb/aporkalypse/rainforest" 	   },
		[GROUND.FOUNDATION] = 		{sound="dontstarve_DLC003/amb/temperate/city",				temperate="dontstarve_DLC003/amb/temperate/city",			 lush="dontstarve_DLC003/amb/warm/city",			humid="dontstarve_DLC003/amb/cold/city", 			aporkalypse = "dontstarve_DLC003/amb/aporkalypse/city" 		   },
		[GROUND.COBBLEROAD] = 		{sound="dontstarve_DLC003/amb/temperate/city",				temperate="dontstarve_DLC003/amb/temperate/city",			 lush="dontstarve_DLC003/amb/warm/city",			humid="dontstarve_DLC003/amb/cold/city", 			aporkalypse = "dontstarve_DLC003/amb/aporkalypse/city" 		   },
		[GROUND.LAWN] = 			{sound="dontstarve_DLC003/amb/temperate/city",				temperate="dontstarve_DLC003/amb/temperate/city",			 lush="dontstarve_DLC003/amb/warm/city",			humid="dontstarve_DLC003/amb/cold/city", 			aporkalypse = "dontstarve_DLC003/amb/aporkalypse/city" 		   },
		[GROUND.GASJUNGLE] = 		{sound="dontstarve_DLC003/amb/temperate/gas_jungle",		temperate="dontstarve_DLC003/amb/temperate/gas_jungle",		 lush="dontstarve_DLC003/amb/warm/gas_jungle",		humid="dontstarve_DLC003/amb/cold/gas_jungle", 		aporkalypse = "dontstarve_DLC003/amb/aporkalypse/gas_jungle" 	   },
		[GROUND.SUBURB] =			{sound="dontstarve_DLC003/amb/temperate/suburbs", 			temperate="dontstarve_DLC003/amb/temperate/suburbs", 		 lush="dontstarve_DLC003/amb/warm/suburbs", 		humid="dontstarve_DLC003/amb/cold/suburbs", 		aporkalypse = "dontstarve_DLC003/amb/aporkalypse/suburbs" 		   },
		[GROUND.FIELDS] =  			{sound="dontstarve_DLC003/amb/temperate/fields", 			temperate="dontstarve_DLC003/amb/temperate/fields",          lush="dontstarve_DLC003/amb/warm/fields", 			humid="dontstarve_DLC003/amb/cold/fields", 			aporkalypse = "dontstarve_DLC003/amb/aporkalypse/fields" 		   },				  			
		[GROUND.PLAINS] =  			{sound="dontstarve_DLC003/amb/temperate/plains", 			temperate="dontstarve_DLC003/amb/temperate/plains", 		 lush="dontstarve_DLC003/amb/warm/plains",			humid="dontstarve_DLC003/amb/cold/plains", 			aporkalypse = "dontstarve_DLC003/amb/aporkalypse/plains" 		   },		
		[GROUND.PAINTED] =   		{sound="dontstarve_DLC003/amb/temperate/painted", 			temperate="dontstarve_DLC003/amb/temperate/painted", 		 lush="dontstarve_DLC003/amb/warm/painted",			humid="dontstarve_DLC003/amb/cold/painted", 		aporkalypse = "dontstarve_DLC003/amb/aporkalypse/painted" 		   },
		[GROUND.LILYPOND] = 		{sound="dontstarve_DLC003/amb/temperate/lilypad", 			temperate="dontstarve_DLC003/amb/temperate/lilypad",		 lush="dontstarve_DLC003/amb/warm/lilypad", 		humid="dontstarve_DLC003/amb/cold/lilypad", 		aporkalypse = "dontstarve_DLC003/amb/aporkalypse/lilypad" 		   },
	...
	for k,v in pairs(self.ambient_sounds) do
		...
		if v.temperate and not self.playing_sounds[v.temperate] then
			self.playing_sounds[v.temperate] = {sound = v.temperate, volume = 0, playing= false}
		end		
		if v.lush and not self.playing_sounds[v.lush] then
			self.playing_sounds[v.lush] = {sound = v.lush, volume = 0, playing= false}
		end				
		if v.humid and not self.playing_sounds[v.humid] then
			self.playing_sounds[v.humid] = {sound = v.humid, volume = 0, playing= false}
		end	
		if v.aporkalypse and not self.playing_sounds[v.aporkalypse] then
			self.playing_sounds[v.aporkalypse] = {sound = v.aporkalypse, volume = 0, playing= false}
		end								
	end
    ...
    self.inst:ListenForEvent( "beginaporkalypse", function(it, data) 
			self:SetSoundParam(2.0)
        end, GetWorld())
...
function AmbientSoundMixer:UpdateAmbientVolumes()
	...
	if self.num_waves > 0 then
		local playing_waves = self.inst.SoundEmitter:PlayingSound("waves")
		
		if playing_waves and season ~= wave_to_season[self.current_wave] then
			self.inst.SoundEmitter:KillSound("waves")
			playing_waves = false
		end
		
		if not playing_waves then
...
function AmbientSoundMixer:UpdateAmbientGeoMix()
	...
	if player and ground then
		...
		local isinterior = TheCamera.interior
		...
		for xx = -half_tiles, half_tiles do
			for yy = -half_tiles, half_tiles do
				...
				elseif tile and self.ambient_sounds[tile] then
					...
					elseif season == SEASONS.TEMPERATE and self.ambient_sounds[tile].temperate then
						sound = self.ambient_sounds[tile].temperate
					elseif season == SEASONS.LUSH and self.ambient_sounds[tile].lush then
						sound = self.ambient_sounds[tile].lush
					elseif season == SEASONS.HUMID and self.ambient_sounds[tile].humid then
						sound = self.ambient_sounds[tile].humid
					elseif season == SEASONS.APORKALYPSE and self.ambient_sounds[tile].aporkalypse then
						sound = self.ambient_sounds[tile].aporkalypse
					else
		...
		if isinterior and interior_spawner.current_interior and interior_spawner.current_interior.ambsnd then
			local sound = interior_spawner.current_interior.ambsnd
			local path = nil

			if self.ambient_sounds[sound] then
				path = self.ambient_sounds[sound].sound
			else
				path = sound
			end

			sound_mix[path] = {count = 99}					
		end

...
function Spawner:TakeOwnership(child)
    ...
    if child.components.citypossession and self.inst.components.citypossession then
...
function Spawner:ReleaseChild()
    ...
    if self:IsOccupied() then
        ...
        if self.inst.components.citypossession then
            if not self.child.components.citypossession then
                self.child:AddComponent("citypossession")
            end

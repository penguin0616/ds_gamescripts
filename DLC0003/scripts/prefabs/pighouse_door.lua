...
--{anim="level1", sound="dontstarve/common/campfire", radius=2, intensity=.75, falloff=.33, colour = {197/255,197/255,170/255}},
	...
	local door_def = {
		my_door_id = "Pighouse Entrance",
		target_door_id = "Bottom Door",
	}
	interior_spawner:AddDoor(inst, door_def)
	
	local interior_def = {
		unique_name = "The Pighouse Door",
		width = 55,
		height = 20,
		prefabs = {
			{ name = "generic_interior", x_offset = -2, z_offset = 0 },
			{ name = "acorn_door", x_offset = 4, z_offset = 0 },
			{ name = "side_door", x_offset = 6.8, z_offset = 0, type = "bottom", my_door_id="Bottom Door", target_door_id="Pighouse Entrance" },
		}
	}	
...
return Prefab( "common/objects/pighouse_door", fn, assets, prefabs ),
	   MakePlacer("common/pighouse_door_placer", "pig_house", "pig_house", "idle")  

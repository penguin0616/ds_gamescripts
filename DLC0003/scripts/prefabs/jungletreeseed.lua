...
local function test_ground(inst, pt)
	local ground_OK = inst:GetIsOnLandOutside(pt.x, pt.y, pt.z)
	local tiletype = GetGroundTypeAtPosition(pt)
	ground_OK = ground_OK and
						tiletype ~= GROUND.ROCKY and tiletype ~= GROUND.ROAD and tiletype ~= GROUND.IMPASSABLE and tiletype ~= GROUND.MAGMAFIELD and

...
local function custom_init(inst)
    ...
    local disguisehat_recipe = Recipe("disguisehat", {Ingredient("twigs", 2), Ingredient("pigskin", 1), Ingredient("beardhair", 1)}, RECIPETABS.DRESS, TECH.NONE, RECIPE_GAME_TYPE.PORKLAND)

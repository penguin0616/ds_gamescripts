...
local assets =
{
    ...
    --Asset("ANIM", "werepig_wildbore_build.zip"),
...
return Prefab("common/characters/wildbore", normal, assets, prefabs),
       Prefab("common/character/wildboreguard", guard, assets, prefabs) 

    ...
    for k, v in pairs(inst.components.herd.members) do
        ...
        if possibleHomeTrees then
            for i, possibleHomeTree in ipairs(possibleHomeTrees) do
                ...
                local tile = GetWorld().Map:GetTileAtPoint(possibleHomeTreePos.x, 0, possibleHomeTreePos.z)
                ...
                local isJungleTile = tile == GROUND.DEEPRAINFOREST or tile == GROUND.DEEPRAINFOREST_NOCANOPY

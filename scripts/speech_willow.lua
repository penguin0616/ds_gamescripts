return {
	...
	DESCRIBE =
	{
		...
		PORTAL_SHIPWRECKED = "Time to get outta here. Aww... it's broken.",
        ...
        FISH3 = "You look kinda dumb.",
        FISH4 = "Found you!",
        FISH5 = "Is living underwater as awful as it sounds?",

        FISH3_COOKED = "Fire burned the grossest bits right off.",
        FISH4_COOKED = "I burned it just right.",
        FISH5_COOKED = "The fire got rid of most of the fish smell.",
        ...
        RESEARCHLAB5 = "Can things burn at sea?",

return {
	...
	--- 5C DLC ------------------------------------------------------------------------------------------------
        ...
        ENCRUSTEDBOAT = "More \"crusty\" than \"encrusted\".",
        ...
        FISH4 = "Always did like fishing.",
        FISH5 = "Nice colours on that one.",

        FISH3_COOKED = "Caught and cooked it myself.",
        FISH4_COOKED = "Mmm, roast fish.",
        FISH5_COOKED = "Looks like I'll be eating for a day.",
        ...
        RESEARCHLAB5 = "Doesn't seem like the best place, but here I am.",

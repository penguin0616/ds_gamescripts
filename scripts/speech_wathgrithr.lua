return {
	...
	{		
        ...
        ENCRUSTEDBOAT = "It's no Viking longship, but it will carry me.",    
        ...
        WALL_ENFORCEDLIMESTONE_ITEM = "To build battle fortifications.",    
        ...
        FISH3 = "Aegir shall not save you this day.",
        FISH4 = "I wish this meat did not have such large eyes.",
        FISH5 = "Thou shalt swim no more.",

        FISH3_COOKED = "Thank Njord for this gift!",
        FISH4_COOKED = "Thank you, fish, for the gift of thy meat.",
        FISH5_COOKED = "Njord gives me my fill this day.",
        ...
        RESEARCHLAB5 = "Aegir, bless me with thy wisdom!",

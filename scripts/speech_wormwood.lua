return {
	...
	ANNOUNCE_SHELTER = "Dry under here",
	ANNOUNCE_BURNT = "Agghh! Too much hot!",
	ANNOUNCE_TOOL_SLIP = "Whoops",
	ANNOUNCE_DAMP = "It's raining! Woohoo!",
	ANNOUNCE_WET = "Rain!",
	ANNOUNCE_WETTER = "Getting wet",
	ANNOUNCE_SOAKED = "Really wet",
    ...
    ANNOUNCE_COMPASS_OUT = "Oh. Direction Thing broke",
    ...
    --ANNOUNCE_BLOOMING_END = {"Leaves are falling"},
	...
	DESCRIBE =
	{
		...
		DEVTOOL = "Strange",
		DEVTOOL_NODEV = "Can't",
		HOUNDFIRE = "Fire Woofer!",
		INVENTORYGRAVE = "Oh. Someone's stuff here",
		INVENTORYMOUND = "Oh. Someone's stuff here",
		MANDRAKE_COOKED = "For belly...",
		ROCK = "Rock. Hello",
		SLURPERPELT = "Oh. Something died",
		TREECLUMP = "Party!",
		...
		GLOMMER = "You're nice. Stay close",
        GLOMMERFLOWER = 
        {
        	GENERIC = "Moon Flower",
        	DEAD = "Poor friend...",
		...
		{
			GENERIC = "Warm? Cold?",
			BURNT = "Fire made it broken",
		},
		HOME = "Home",
		HOMESIGN = 
		{
			GENERIC = "Words on friends",
			UNWRITTEN = "Needs words",
			BURNT = "(sigh)",
		},
		BEEBOX =
		{
		...
		UNAGI = "Sea Wiggly wiggly in belly",
		EYETURRET = "Pew!",
		...
		MINOTAUR = "Don't want to fight!",	--Monster in labyrinth
		SPIDER_DROPPER = "Aggh! Scary!",	--White spider that comes from the roof
		NIGHTMARELIGHT = "Night light for scary times",	--Lights that activate during nightmare.
		GREENGEM = "Looks familiar...",
		RELIC = "Old rock",	--Fixed relic
		RUINS_RUBBLE = "Can fix it?",	--Broken relic
		MULTITOOL_AXE_PICKAXE = "Handy Stick",	--Works as axe and pickaxe
		ORANGESTAFF = "Poof Stick",	--Teleports player.
		YELLOWAMULET = "Can go zoomy now!",	--Emits light, player walks faster.
		GREENAMULET = "Helps for building",	--Reduce cost of crafting
        ...
        CAVE_BANANA = "Sweet Hair from friend!",
        CAVE_BANANA_COOKED = "Mmmmm...",
		...
		MUSHTREE_TALL="Growing nicely",
		MUSHTREE_MEDIUM="Fun guy",
		MUSHTREE_SMALL="Hey there!",
		...
		CORN_COOKED = "Pop! Pop!",
		CORN_SEEDS = "The dirt likes these",
		CROW =
		{
			GENERIC = "Caw Tweeter!",
			HELD = "Needs a home",
		...
		DEADLYFEAST = "Nope",
		DEERCLOPS = "Branch Head branches",
		...
		EARMUFFS = "Furry friends for ears",
		ACORN = 
		{
		    GENERIC = "So cute!",
		    PLANTED = "Grow big and strong!",
		},
		EVERGREEN =
		{
			BURNING = "Nonononono!",
		...
		FISHTACOS = "What's wrong with eyes, Glub Glubs?",
		FISH_MED = "Hello, Glub Glub",
		...
		PINECONE = 
		{
		    GENERIC = "Aw... Little baby friends",
		    PLANTED = "Yay!",
		},
		...
		WALRUSHAT = "Head thing for head",
		WALRUS_CAMP =
		{
			EMPTY = "No one here",
			GENERIC = "Ball of home",
		},
		...
		BUSH_VINE = "Ropey friend",
		SNAKEDEN = "Ropey friend",--I don't think these should have diff name or examine text
		CANNONSHOT = "Pa-KOW!!",
		CAPTAINHAT = "Ahoy!",
		...
		TRINKET_13 = "Psht",
		TRINKET_14 = "Hello!... Hello?",
		TRINKET_15 = "Plink Plink",
		TRINKET_16 = "Name?",
		TRINKET_17 = "(sniff, sniff) Whew-wee!",
		TRINKET_18 = "Oh. Broken",
		TRINKET_19 = "Hmm...",
		...
		DRAGOONSPIT = "Patuey",
		FISH_RAW = "Glub Glub",
		FISH_RAW_SMALL = "Wee Glub Glub",
		FISH_RAW_SMALL_COOKED = "Cute little belly stuff",
		...
		TRINKET_20 = "Pretty machine",
		TRINKET_21 = "Baby floater",
		TRINKET_22 = "Hmm...",
		TRINKET_23 = "Green stick glass",
		TROPICAL_FISH = "Pretty Glub Glub",
		...
		WOODLEGSBOAT = "Arrg Floater",
		WOODLEGSHAT = "Arrg Head Thing",
		WOODLEGSSAIL = "Arrg Wind Nabber",
		WOODLEGS_KEY1 = "Key",
        ...
        FISH3 = "Purple Glub Glub",
        FISH4 = "Yellow Glub Glub",
        FISH5 = "Big Lip Glub Glub",

        FISH3_COOKED = "No more swimming",
        FISH4_COOKED = "Glub Glub for belly",
        FISH5_COOKED = "Fins are yummy",
        ...
        RESEARCHLAB5 = "Water things maker",
      ...
      PIGMAN_USHER = 
		...
		QUACKENDRILL = "Finds the Gloopy Pools",
        ...
        BRUSH = "Buddys like the brushing",
        ...
        FEATHERPENCIL = "Draws the pretty pictures",

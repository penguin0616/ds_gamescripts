return {
	...
	DESCRIBE =
	{
        ...
        ENCRUSTEDBOAT = "It seems sturdy enough to carry me.",
        ...
        FISH3 = "Truly an ugly creature.",
        FISH4 = "Delightfully pinstriped.",
        FISH5 = "Don't you ever blink?",

        FISH3_COOKED = "Purple on the outside, pink in the middle.",
        FISH4_COOKED = "I'll be picking bones out of my teeth for weeks.",
        FISH5_COOKED = "Don't worry, there's plenty of them in the sea.",
        ...
        RESEARCHLAB5 = "There are watery mysteries to be unlocked yet.",

...
local function GetFaceTargetFn(inst)
    local homePos = inst.components.knownlocations:GetLocation("home")
    if homePos ~= nil and inst:GetDistanceSqToPoint(homePos) > GO_HOME_DIST * GO_HOME_DIST then
        return
    end
...
local function KeepFaceTargetFn(inst, target)
    ...
    return (homePos == nil or
            inst:GetDistanceSqToPoint(homePos) <= GO_HOME_DIST * GO_HOME_DIST)
...
local function ShouldGoHome(inst)
    ...
    local dist_sq = inst:GetDistanceSqToPoint(homePos)

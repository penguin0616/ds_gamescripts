...
local BigPopupDialogScreen = Class(Screen, function(self, title, text, buttons, timeout, button_spacing, title_pos)
    ...
    self.title:SetPosition(title_pos or Vector3(0, 135, 0))
